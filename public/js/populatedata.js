...
function populatePublicMessages() {
    ...
    $.ajax({
        ...
        success: function (results) {
         ...
         //   console.log("Feedback:" + results.messageAndStatusCode[0].MessageObject.content );

            console.log("Feedback:" + results.messageAndStatusCode[4].MessageObject.content );
            console.log("Feedback:" + results.messageAndStatusCode[4].AuthorStatusCode[0].statusCode );
