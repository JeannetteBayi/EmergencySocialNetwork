...
class User {
    ...
    */
    constructor(username, password, createdAt, lastLogin, lastStatusCode, accountStatus, approvalStatus, onlineStatus, socketId, eemail, eaddress, ephone, elatLoc, elongLoc) {
   ...
   */
    ...
    /*
           Method: update more information
           Purpose: 
           Parameter:
           Return:
